...
player1_score = 0
player2_score = 0
winning_score = 5  # Første til 5 point vinder
...
while running:
    ...
    if keys[pygame.K_s]: player2_y += speed2
        ...
        # Tilføj grænser!
    player1_x = max(0, min(WIDTH - 50, player1_x))
    player1_y = max(0, min(HEIGHT - 50, player1_y))
    player2_x = max(0, min(WIDTH - 50, player2_x))
    player2_y = max(0, min(HEIGHT - 50, player2_y))
